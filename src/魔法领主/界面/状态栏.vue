...
interface StatData {
  ...
  破处事件?: Array<{ 时间?: string; 地点?: string; 内容?: string }>;
}
...
:root {
  ...
  --bg-main: #0f0a1f;
  --bg-panel: rgba(20, 12, 40, 0.75);
  --border-color: rgba(138, 100, 200, 0.4);
  --user-color-primary: #a78bfa;
  --user-color-secondary: #c4b5fd;
  --text-primary: #f5f3ff;
...
.world-info {
  background: linear-gradient(135deg, rgba(20, 12, 40, 0.85) 0%, rgba(30, 18, 60, 0.75) 100%);
  border-radius: 0.5rem;
  padding: 0.75rem;
...
.tab-bar {
  ...
  justify-content: space-between;
  margin-top: 0.4rem;
  background: linear-gradient(135deg, rgba(20, 12, 40, 0.6) 0%, rgba(30, 18, 60, 0.4) 100%);
