  ...
  <div>
    ...
    <div class="hh-content">
      <div class="hh-card">
        ...
        <div class="hh-row"><span class="hh-label">时间</span><span class="hh-value">{{ displayValue(world.当前时间) }}</span></div>
        <div class="hh-row"><span class="hh-label">地点</span><span class="hh-value">{{ displayValue(world.当前地点) }}</span></div>
        <div class="hh-row"><span class="hh-label">阶段</span><span class="hh-value">{{ displayValue(world.当前主线阶段) }}</span></div>
        <div class="hh-row"><span class="hh-label">发展</span><span class="hh-value">{{ displayValue(world.合欢宗发展等级) }}</span></div>
        <div class="hh-row"><span class="hh-label">商城</span><span class="hh-value">{{ displayValue(world.商城等级) }}</span></div>
        <div class="hh-row"><span class="hh-label">权限</span><span class="hh-value">{{ displayValue(world.系统权限等级) }}</span></div>
        <div class="hh-row"><span class="hh-label">外界时间</span><span class="hh-value">{{ displayValue(world.外界时间状态) }}</span></div>
      </div>

      <div class="hh-card">
        <div class="hh-card-title">名望</div>
        <div class="hh-row"><span class="hh-label">校园</span><span class="hh-value">{{ displayValue(world.校园名望) }}</span></div>
        <div class="hh-row"><span class="hh-label">城市</span><span class="hh-value">{{ displayValue(world.城市名望) }}</span></div>
      </div>

      <div class="hh-card">
        <div class="hh-card-title">风险</div>
        <div class="hh-row"><span class="hh-label">社交</span><span class="hh-value">{{ displayValue(world.社交风险值) }}</span></div>
        <div class="hh-row"><span class="hh-label">曝光</span><span class="hh-value">{{ displayValue(world.曝光风险值) }}</span></div>
      </div>
