  ...
  <div>
    ...
    <div class="hh-content">
      <div class="hh-card">
        ...
        <div class="hh-row"><span class="hh-label">性别</span><span class="hh-value">{{ displayValue(user.性别) }}</span></div>
        <div class="hh-row"><span class="hh-label">综合</span><span class="hh-value">{{ score }} / {{ level }}</span></div>
        <div class="hh-row"><span class="hh-label">容貌</span><span class="hh-value">{{ displayValue(user.容貌) }}</span></div>
        <div class="hh-row"><span class="hh-label">气质</span><span class="hh-value">{{ displayValue(user.气质) }}</span></div>
        <div class="hh-row"><span class="hh-label">身材</span><span class="hh-value">{{ displayValue(user.身材) }}</span></div>
      ...
      <div class="hh-card">
        ...
        <div class="hh-row"><span class="hh-label">合欢值</span><span class="hh-value">{{ displayValue(user.合欢值) }}</span></div>
        <div class="hh-row"><span class="hh-label">累计获得</span><span class="hh-value">{{ displayValue(user.累计获得合欢值) }}</span></div>
        <div class="hh-row"><span class="hh-label">累计消费</span><span class="hh-value">{{ displayValue(user.累计消费合欢值) }}</span></div>
        <div class="hh-row"><span class="hh-label">现金</span><span class="hh-value">{{ displayValue(user.现金) }}</span></div>
        <div class="hh-row"><span class="hh-label">不同目标</span><span class="hh-value">{{ displayValue(user.已有效双修不同目标数) }}</span></div>
        <div class="hh-row"><span class="hh-label">总次数</span><span class="hh-value">{{ displayValue(user.有效双修总次数) }}</span></div>
      </div>
