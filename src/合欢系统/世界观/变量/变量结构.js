...
export const Schema = z.object({
  世界: z.object({
    ...
    校园名望: score('0-100，校园/熟人圈正面名望'),
    城市名望: score('0-100，城市/社会层面名望'),
    社交风险值: score('0-100，关系翻车、流言、口碑风险'),
    曝光风险值: score('0-100，系统能力、异常资金、异常物品被怀疑的风险'),
  ...
  目标: z
    .record(
      ...
      z.object({
        ...
        关系阶段: z.string().describe('陌生/认识/熟悉/暧昧/亲密/稳定关系/排斥/敌对'),
        关系状态: z.string().describe('同学/朋友/暧昧/恋人/炮友/合作/拉黑等'),
        好感度: score('0-100'),
        戒备心: score('0-100'),
        风险标记: limitedList('该目标相关风险、雷点、社交关系', 8),
        备注: z.string(),
      }),
    )
    .describe('重要攻略目标记录'),
  ...
  宗门: z.object({
    宗门名称: z.string(),
    宗门理念: z.string(),
    当前路线: z.string().describe('校园扩张/娱乐圈/商业组织/名流资源/后宫核心/融合路线'),
    宗门资金: nonNegative('宗门公共资金，单位元'),
    宗门规模: nonNegative('宗门成员与外围网络规模'),
    影响力: score('0-100，宗门综合影响力'),
    隐蔽度: score('0-100，越高越不易暴露'),
    稳定度: score('0-100，组织内部稳定'),
    现代化指数: score('0-100，组织制度化、数据化、产业化程度'),
    成员: z
      .record(
        z.string(),
        z.object({
