...
.character-detail-content {
  background: linear-gradient(135deg, rgba(43, 29, 14, 0.95) 0%, rgba(62, 42, 20, 0.9) 100%);
...
.character-detail-header {
  ...
  position: sticky;
  top: 0;
  background: linear-gradient(135deg, rgba(62, 42, 20, 0.95) 0%, rgba(43, 29, 14, 0.98) 100%);
  z-index: 1;
}
